...
export default async function TrainingPage() {
  ...
  return (
    <AppShell demoMode={demoMode} rail={<AnnouncementCenter messages={messages.slice(0, 2)} />}>
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
        <TrainingActions direction={training.direction} tasks={training.tasks} demoMode={demoMode} />
